...
const projects: Project[] = [
  ...
  {
    name: "real estate mobile marketplace",
    category: "mobile development",
    description:
      "cross-platform mobile app connecting buyers, sellers, and agents with real-time property listings and virtual tours.",
    challenge:
      "building a mobile-first real estate experience with interactive maps, virtual tours, and real-time messaging.",
    solution:
      "React Native app with map integration, 360° virtual tours, and instant messaging.",
    stack: ["React Native", "TypeScript", "Firebase", "Google Maps API"],
