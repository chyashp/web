...
const communityLinks = [
  {
    name: 'Missions',
    href: '/missions',
    description: 'Join real product teams and build mobile apps in 6-week collaborative projects.',
    icon: RocketLaunchIcon,
  },
  {
    name: 'Tutorials',
    href: '/tutorials',
    description: 'Step-by-step guides to master React Native, TypeScript, and mobile development.',
    icon: BookOpenIcon,
  },
  {
    name: 'How It Works',
    href: '/how-it-works',
    description: 'Learn about our collaborative team-based approach to mobile development learning.',
    icon: AcademicCapIcon,
  },
  {
    name: 'FAQ',
    href: '/faq',
    description: 'Get answers to common questions about the nanushi community platform.',
...
const features = [
  {
    ...
    description: 'Work with developers, designers, and product managers in a realistic team environment.',
    icon: UserGroupIcon,
  },
  {
    name: 'Hands-On Projects',
    description: 'Build production-ready mobile apps from scratch using React Native and modern tools.',
    icon: CodeBracketIcon,
  },
  {
    name: 'Structured Learning',
    description: '6-week missions with clear milestones, code reviews, and professional workflows.',
    icon: AcademicCapIcon,
  },
]
        ...
        <div className="mx-auto max-w-7xl px-6 pt-24 pb-16 sm:pt-32 sm:pb-24 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-lg leading-8 text-gray-600">
              Gain hands-on experience through 6-week mobile app projects with developers, designers, and product managers.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-7xl px-6 py-16 sm:py-24 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            The nanushi community is designed to bridge the gap between learning and professional mobile development through collaborative, project-based experience.
          </p>
        </div>
            ...
            {features.map((feature) => (
              <div key={feature.name} className="flex flex-col">
                <dt className="flex items-center gap-x-3 text-lg font-semibold leading-7 text-navy-500">
                  <feature.icon className="h-8 w-8 flex-none text-primary-500" aria-hidden="true" />
                  {feature.name}
                </dt>
      ...
      <div className="bg-gray-50 py-16 sm:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg leading-8 text-gray-600">
              Everything you need to get started with collaborative mobile development.
            </p>
          </div>
            ...
            {communityLinks.map((link) => (
              ...
              >
                <div className="flex items-center gap-x-4">
                  ...
                  <h3 className="text-xl font-semibold text-navy-500">{link.name}</h3>
                </div>
                <p className="text-base leading-7 text-gray-600">{link.description}</p>
        ...
        <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
          <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-8 lg:max-w-none lg:grid-cols-2">
            <div className="flex flex-col border-l-4 border-primary-500 pl-6">
              <dt className="text-xl font-semibold text-navy-500 mb-4">Technical Skills</dt>
              <dd className="flex flex-auto flex-col text-base leading-7 text-gray-600">
                <ul className="space-y-3">
                  <li className="flex items-start gap-x-2">
                    <svg className="h-6 w-6 flex-none text-primary-500" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
            ...
            <div className="flex flex-col border-l-4 border-primary-500 pl-6">
              <dt className="text-xl font-semibold text-navy-500 mb-4">Professional Experience</dt>
              <dd className="flex flex-auto flex-col text-base leading-7 text-gray-600">
                <ul className="space-y-3">
                  <li className="flex items-start gap-x-2">
                    <svg className="h-6 w-6 flex-none text-primary-500" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-300">
              Start building real mobile apps with our community of developers, designers, and product managers.
            </p>
